...
namespace Sres.Net.EEIP
{
  public class EEIPClient
  {
        ...
        if (ni.NetworkInterfaceType == NetworkInterfaceType.Wireless80211 || ni.NetworkInterfaceType == NetworkInterfaceType.Ethernet)
        {
          ...
          foreach (UnicastIPAddressInformation ip in ni.GetIPProperties().UnicastAddresses)
          {
            if (ip.Address.AddressFamily == AddressFamily.InterNetwork)
            {
              ...
              IPEndPoint endPoint = new IPEndPoint(System.Net.IPAddress.Parse(multicastAddress), 44818);
    ...
    public void ForwardOpen(bool largeForwardOpen)
    {
      ...
      IPEndPoint endPointReceive = new IPEndPoint(System.Net.IPAddress.Any, OriginatorUDPPort);
      ...
      {
        IPAddress multicast = (new IPAddress(multicastAddress));
    ...
    private void sendUDP()
    {
      ...
      while (!stopUDP)
      {
        ...
        IPEndPoint endPointsend = new IPEndPoint(System.Net.IPAddress.Parse(IPAddress), TargetUDPPort);
